...
class CombinedCalculator(ctk.CTk):
    def __init__(self):
        super().__init__()
        ...
        self.result_frame.grid(row=5, column=0, padx=20, pady=(0, 20), sticky="nsew")
        ...
        self.result_text.grid(row=0, column=0, padx=(20, 0), pady=20, sticky="nsew")
    ...
    def calculate(self):
        try:
            ...
            self.result_text.insert(tk.END, f"{formula} = {result:,}")
